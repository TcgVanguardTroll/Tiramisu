...
A portable multi-agent orchestration system for personal software development. Tiramisu coordinates specialized AI agents to decompose, implement, review, and track engineering work — so you don't have to context-switch between every tool yourself.
...
| **Éclair** | SDE — writes code, creates PRs, addresses review feedback | Direct, surgical |
| **Mochi** | Brainstorm — explores approaches, debates tradeoffs | Creative, challenges assumptions |
| **Cannoli** | Research — gathers context, reads docs, cites sources | Thorough, precise |
| **Madeleine** | Knowledge — manages knowledge base, triages learnings | Librarian, systematic |
